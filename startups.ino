void firstRunSetup()
{
  ...
  if(EEPROM.read(EEPROMAddress)!= EEPROMValue)
  {
    ...
    EEPROM.write(17,29); // 17 // heater off temp, def 19
    EEPROM.write(18,25); // 18 // heater on temp, def 25
    EEPROM.write(19,30); // 19 // heater alarm temp, def 30
    */
    
    //yusuf
    EEPROM.write(16,1);  // 16 // chiller settings saved (0 for no, 1 for yes)
    EEPROM.write(17,23); // 17 // chiller off temp, def 19
    EEPROM.write(18,27); // 18 // chiller on temp, def 25
    EEPROM.write(19,22); // 19 // chiller alarm temp, def 30
    //yusuf
    ...
    EEPROM.write(323,1);   //       Wed
    EEPROM.write(324,1);   //       Thur
    EEPROM.write(325,1);   //       Fri
    ...
    EEPROM.write(332,1);   //       Wed
    EEPROM.write(333,1);   //       Thur
    ...
    EEPROM.write(341,1);   //       Wed
    EEPROM.write(342,1);   //       Thur
    ...
    EEPROM.write(350,1);   //       Wed
    EEPROM.write(351,1);   //       Thur
    ...
    EEPROM.write(359,1);   //       Wed
    EEPROM.write(360,1);   //       Thur
    ...
    EEPROM.write(368,1);   //       Wed
    EEPROM.write(369,1);   //       Thur
    EEPROM.write(370,1);   //       Fri
    EEPROM.write(371,1);   //       Sat
    //yusuf
    ...
    EEPROM.write(462,500); // 41 // dosing 6 reserviors capacity in mL
...
void readDosingSchedule()
{
  ...
  //yusuf
  pump4.onHour = EEPROM.read(327);
  pump4.onMinute = EEPROM.read(328);

  pump4.Sunday = EEPROM.read(329);
  pump4.Monday = EEPROM.read(330);
  pump4.Tuesday = EEPROM.read(331);
  pump4.Wednesday = EEPROM.read(332);
  pump4.Thursday = EEPROM.read(333);
  pump4.Friday = EEPROM.read(334);
  pump4.Saturday = EEPROM.read(335);

  pump5.onHour = EEPROM.read(336);
  pump5.onMinute = EEPROM.read(337);

  pump5.Sunday = EEPROM.read(338);
  pump5.Monday = EEPROM.read(339);
  pump5.Tuesday = EEPROM.read(340);
  pump5.Wednesday = EEPROM.read(341);
  pump5.Thursday = EEPROM.read(342);
  pump5.Friday = EEPROM.read(343);
  pump5.Saturday = EEPROM.read(344);

  pump6.onHour = EEPROM.read(345);
  pump6.onMinute = EEPROM.read(346);

  pump6.Sunday = EEPROM.read(347);
  pump6.Monday = EEPROM.read(348);
  pump6.Tuesday = EEPROM.read(349);
  pump6.Wednesday = EEPROM.read(350);
  pump6.Thursday = EEPROM.read(351);
  pump6.Friday = EEPROM.read(352);
  pump6.Saturday = EEPROM.read(353);

  pump7.onHour = EEPROM.read(354);
  pump7.onMinute = EEPROM.read(355);

  pump7.Sunday = EEPROM.read(356);
  pump7.Monday = EEPROM.read(357);
  pump7.Tuesday = EEPROM.read(358);
  pump7.Wednesday = EEPROM.read(359);
  pump7.Thursday = EEPROM.read(360);
  pump7.Friday = EEPROM.read(361);
  pump7.Saturday = EEPROM.read(362);

  pump8.onHour = EEPROM.read(363);
  pump8.onMinute = EEPROM.read(364);

  pump8.Sunday = EEPROM.read(365);
  pump8.Monday = EEPROM.read(366);
  pump8.Tuesday = EEPROM.read(367);
  pump8.Wednesday = EEPROM.read(368);
  pump8.Thursday = EEPROM.read(369);
  pump8.Friday = EEPROM.read(370);
  pump8.Saturday = EEPROM.read(371);
