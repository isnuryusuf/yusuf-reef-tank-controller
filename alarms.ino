void updateAlarms()
{
  ...
  if (pump4.Sunday==1)
  {
    Alarm.alarmRepeat(dowSunday, pump4.onHour,pump4.onMinute,0,AlarmPump4);
  }
  if (pump5.Sunday==1)
  {
    Alarm.alarmRepeat(dowSunday, pump5.onHour,pump5.onMinute,0,AlarmPump5);
  }
  if (pump6.Sunday==1)
  {
    Alarm.alarmRepeat(dowSunday, pump6.onHour,pump6.onMinute,0,AlarmPump6);
  }
  if (pump7.Sunday==1)
  {
    Alarm.alarmRepeat(dowSunday, pump7.onHour,pump7.onMinute,0,AlarmPump7);
  }
  if (pump8.Sunday==1)
  {
    Alarm.alarmRepeat(dowSunday, pump8.onHour,pump8.onMinute,0,AlarmPump8);
  }
  //yusuf
  ...
  if (pump4.Monday==1)
  {
    Alarm.alarmRepeat(dowMonday, pump4.onHour,pump4.onMinute,0,AlarmPump4);
  }
  if (pump5.Monday==1)
  {
    Alarm.alarmRepeat(dowMonday, pump5.onHour,pump5.onMinute,0,AlarmPump5);
  }
  if (pump6.Monday==1)
  {
    Alarm.alarmRepeat(dowMonday, pump6.onHour,pump6.onMinute,0,AlarmPump6);
  }
  if (pump7.Monday==1)
  {
    Alarm.alarmRepeat(dowMonday, pump7.onHour,pump7.onMinute,0,AlarmPump7);
  }
  if (pump8.Monday==1)
  {
    Alarm.alarmRepeat(dowMonday, pump8.onHour,pump8.onMinute,0,AlarmPump8);
  }
  //yusuf
  ...
  if (pump4.Tuesday==1)
  {
    Alarm.alarmRepeat(dowTuesday, pump4.onHour,pump4.onMinute,0,AlarmPump4);
  }
  if (pump5.Tuesday==1)
  {
    Alarm.alarmRepeat(dowTuesday, pump5.onHour,pump5.onMinute,0,AlarmPump5);
  }
  if (pump6.Tuesday==1)
  {
    Alarm.alarmRepeat(dowTuesday, pump6.onHour,pump6.onMinute,0,AlarmPump6);
  }
  if (pump7.Tuesday==1)
  {
    Alarm.alarmRepeat(dowTuesday, pump7.onHour,pump7.onMinute,0,AlarmPump7);
  }
  if (pump8.Tuesday==1)
  {
    Alarm.alarmRepeat(dowTuesday, pump8.onHour,pump8.onMinute,0,AlarmPump8);
  }
  //yusuf
  ...
  //yusuf
  if (pump4.Wednesday==1)
  {
    Alarm.alarmRepeat(dowWednesday, pump4.onHour,pump4.onMinute,0,AlarmPump4);
  }
  if (pump5.Wednesday==1)
  {
    Alarm.alarmRepeat(dowWednesday, pump5.onHour,pump5.onMinute,0,AlarmPump5);
  }
  if (pump6.Wednesday==1)
  {
    Alarm.alarmRepeat(dowWednesday, pump6.onHour,pump6.onMinute,0,AlarmPump6);
  }
  if (pump7.Wednesday==1)
  {
    Alarm.alarmRepeat(dowWednesday, pump7.onHour,pump7.onMinute,0,AlarmPump7);
  }
  if (pump8.Wednesday==1)
  {
    Alarm.alarmRepeat(dowWednesday, pump8.onHour,pump8.onMinute,0,AlarmPump8);
  }
  //yusuf
  ...
  if (pump4.Thursday==1)
  {
    Alarm.alarmRepeat(dowThursday, pump4.onHour,pump4.onMinute,0,AlarmPump4);
  }
  if (pump5.Thursday==1)
  {
    Alarm.alarmRepeat(dowThursday, pump5.onHour,pump5.onMinute,0,AlarmPump5);
  }
  if (pump6.Thursday==1)
  {
    Alarm.alarmRepeat(dowThursday, pump6.onHour,pump6.onMinute,0,AlarmPump6);
  }
  if (pump7.Thursday==1)
  {
    Alarm.alarmRepeat(dowThursday, pump7.onHour,pump7.onMinute,0,AlarmPump7);
  }
  if (pump8.Thursday==1)
  {
    Alarm.alarmRepeat(dowThursday, pump8.onHour,pump8.onMinute,0,AlarmPump8);
  }
  //yusuf
  ...
  if (pump4.Friday==1)
  {
    Alarm.alarmRepeat(dowFriday, pump4.onHour,pump4.onMinute,0,AlarmPump4);
  }
  if (pump5.Friday==1)
  {
    Alarm.alarmRepeat(dowFriday, pump5.onHour,pump5.onMinute,0,AlarmPump5);
  }
  if (pump6.Friday==1)
  {
    Alarm.alarmRepeat(dowFriday, pump6.onHour,pump6.onMinute,0,AlarmPump6);
  }
  if (pump7.Friday==1)
  {
    Alarm.alarmRepeat(dowFriday, pump7.onHour,pump7.onMinute,0,AlarmPump7);
  }
  if (pump8.Friday==1)
  {
    Alarm.alarmRepeat(dowFriday, pump8.onHour,pump8.onMinute,0,AlarmPump8);
  }
  //yusuf
  ...
  if (pump4.Saturday==1)
  {
    Alarm.alarmRepeat(dowSaturday, pump4.onHour,pump4.onMinute,0,AlarmPump4);
  }
  if (pump5.Saturday==1)
  {
    Alarm.alarmRepeat(dowSaturday, pump5.onHour,pump5.onMinute,0,AlarmPump5);
  }
  if (pump6.Saturday==1)
  {
    Alarm.alarmRepeat(dowSaturday, pump6.onHour,pump6.onMinute,0,AlarmPump6);
  }
  if (pump7.Saturday==1)
  {
    Alarm.alarmRepeat(dowSaturday, pump7.onHour,pump7.onMinute,0,AlarmPump7);
  }
  if (pump8.Saturday==1)
  {
    Alarm.alarmRepeat(dowSaturday, pump8.onHour,pump8.onMinute,0,AlarmPump8);
  }
  //yusuf
...
void AlarmPump4()
{
  Serial.print(F("Pump4 started.\n"));
  unsigned int pumpTime=EEPROM.read(455);  // 34 // pump 4 sec/ml
  unsigned int doseAmt=EEPROM.read(450); // 29 // dose in mL
  pumpTime=((pumpTime*10)*doseAmt); // multiply ms/mL by number of mL to pump
  analogWrite(dosingPump4, 255);
  
  pump4State = true;
  pump4StartMillis = millis();
  pump4millis = pumpTime;

  // update resevoir volume, storing as high/low bytes so we can store bigger numbers
  unsigned int vol_H=EEPROM.read(465); // read the remaining volume for pump 4 (high byte, ^10)
  unsigned int vol_L=EEPROM.read(466); // read the remaining volume for pump 4 (low byte)
  unsigned int vol= ((vol_H*10)+vol_L); // combine high and low byte to get volume
  if(vol > doseAmt)
  {
    vol=(vol-doseAmt); // subtract off what we just dosed
  ...
  EEPROM.write(465,vol_H); // write high byte to memory
  EEPROM.write(466,vol_L); // write low byte to memory
...
void AlarmPump5()
{
  Serial.print(F("Pump5 started.\n"));
  unsigned int pumpTime=EEPROM.read(456);  // 35 // pump 5 sec/ml
  unsigned int doseAmt=EEPROM.read(451); // 30 // dose in mL
  pumpTime=((pumpTime*10)*doseAmt); // multiply ms/mL by number of mL to pump
  analogWrite(dosingPump5, 255);
  
  pump5State = true;
  pump5StartMillis = millis();
  pump5millis = pumpTime;

  // update resevoir volume, storing as high/low bytes so we can store bigger numbers
  unsigned int vol_H=EEPROM.read(467); // read the remaining volume for pump 5 (high byte, ^10)
  unsigned int vol_L=EEPROM.read(468); // read the remaining volume for pump 5 (low byte)
  unsigned int vol= ((vol_H*10)+vol_L); // combine high and low byte to get volume
  if(vol > doseAmt)
  {
    vol=(vol-doseAmt); // subtract off what we just dosed
  ...
  EEPROM.write(467,vol_H); // write high byte to memory
  EEPROM.write(468,vol_L); // write low byte to memory
...
void AlarmPump6()
{
  Serial.print(F("Pump6 started.\n"));
  unsigned int pumpTime=EEPROM.read(457);  // 36 // pump 6 sec/ml
  unsigned int doseAmt=EEPROM.read(452); // 31 // dose in mL
  pumpTime=((pumpTime*10)*doseAmt); // multiply ms/mL by number of mL to pump
  analogWrite(dosingPump6, 255);
  
  pump6State = true;
  pump6StartMillis = millis();
  pump6millis = pumpTime;

  // update resevoir volume, storing as high/low bytes so we can store bigger numbers
  unsigned int vol_H=EEPROM.read(469); // read the remaining volume for pump 6 (high byte, ^10)
  unsigned int vol_L=EEPROM.read(470); // read the remaining volume for pump 6 (low byte)
  unsigned int vol= ((vol_H*10)+vol_L); // combine high and low byte to get volume
  if(vol > doseAmt)
  {
    vol=(vol-doseAmt); // subtract off what we just dosed
  ...
  EEPROM.write(469,vol_H); // write high byte to memory
  EEPROM.write(470,vol_L); // write low byte to memory
...
void AlarmPump7()
{
  Serial.print(F("Pump7 started.\n"));
  unsigned int pumpTime=EEPROM.read(458);  // 37 // pump 7 sec/ml
  unsigned int doseAmt=EEPROM.read(453); // 32 // dose in mL
  pumpTime=((pumpTime*10)*doseAmt); // multiply ms/mL by number of mL to pump
  analogWrite(dosingPump7, 255);
  
  pump7State = true;
  pump7StartMillis = millis();
  pump7millis = pumpTime;

  // update resevoir volume, storing as high/low bytes so we can store bigger numbers
  unsigned int vol_H=EEPROM.read(471); // read the remaining volume for pump 7 (high byte, ^10)
  unsigned int vol_L=EEPROM.read(472); // read the remaining volume for pump 7 (low byte)
  unsigned int vol= ((vol_H*10)+vol_L); // combine high and low byte to get volume
  if(vol > doseAmt)
  {
    vol=(vol-doseAmt); // subtract off what we just dosed
  ...
  EEPROM.write(471,vol_H); // write high byte to memory
  EEPROM.write(472,vol_L); // write low byte to memory
...
void AlarmPump8()
{
  Serial.print(F("Pump8 started.\n"));
  unsigned int pumpTime=EEPROM.read(459);  // 38 // pump 8 sec/ml
  unsigned int doseAmt=EEPROM.read(454); // 33 // dose in mL
  pumpTime=((pumpTime*10)*doseAmt); // multiply ms/mL by number of mL to pump
  analogWrite(dosingPump8, 255);
  
  pump8State = true;
  pump8StartMillis = millis();
  pump8millis = pumpTime;

  // update resevoir volume, storing as high/low bytes so we can store bigger numbers
  unsigned int vol_H=EEPROM.read(473); // read the remaining volume for pump 8 (high byte, ^10)
  unsigned int vol_L=EEPROM.read(474); // read the remaining volume for pump 8 (low byte)
  unsigned int vol= ((vol_H*10)+vol_L); // combine high and low byte to get volume
  if(vol > doseAmt)
  {
    vol=(vol-doseAmt); // subtract off what we just dosed
  ...
  EEPROM.write(473,vol_H); // write high byte to memory
  EEPROM.write(474,vol_L); // write low byte to memory
