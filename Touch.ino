void processMyTouch() // this is a huge block dedicated to processing all touch screen events
{
  ...
  case 10:    // dosing configuration screen
    ...
    else if ((x>=145)&&(x<=169)&&(y>=101)&&(y<=125))   // dose up
    {
      ...
      {
        doseAmt=EEPROM.read(450); // 29 // pump4 dose in mL
      }
      else if (scheduleItem==5)
      {
        doseAmt=EEPROM.read(451); // 30 // pump5 dose in mL
      }
      else if (scheduleItem==6)
      {
        doseAmt=EEPROM.read(452); // 31 // pump6 dose in mL
      }
      else if (scheduleItem==7)
      {
        doseAmt=EEPROM.read(453); // 32 // pump7 dose in mL
      }
      else if (scheduleItem==8)
      {
        doseAmt=EEPROM.read(454); // 33 // pump8 dose in mL
      }    
      //yusuf
    ...
    else if ((x>=145)&&(x<=169)&&(y>=233)&&(y<=257))   // resevoir volume up by 10
    {
      ...
      {
        doseCap=EEPROM.read(463); // 42 // dosing 3 resevior capacity in mL;
      }
      else if (scheduleItem==8)
      {
        doseCap=EEPROM.read(464); // 43 // dosing 3 resevior capacity in mL;
      }
      //yusuf
  ...
  case 15:  // macro and micro dosing schedule
    ...
    else if ((x>=85)&&(x<=109)&&(y>=110)&&(y<=134)) // on hour up
    {
      ...
      //yusuf
      else if (scheduleItem==4) // for Pump4
      {
        if (pump4.onHour==23) pump4.onHour=0;
        else pump4.onHour=pump4.onHour+1;
        onHour=pump4.onHour;
        EEPROM.write(327,onHour); // save to memory
      }
      else if (scheduleItem==5) // for Pump5
      {
        if (pump5.onHour==23) pump5.onHour=0;
        else pump5.onHour=pump5.onHour+1;
        onHour=pump5.onHour;
        EEPROM.write(336,onHour); // save to memory
      }
      else if (scheduleItem==6) // for Pump6
      {
        if (pump6.onHour==23) pump6.onHour=0;
        else pump6.onHour=pump6.onHour+1;
        onHour=pump6.onHour;
        EEPROM.write(345,onHour); // save to memory
      }
      else if (scheduleItem==7) // for Pump7
      {
        if (pump7.onHour==23) pump7.onHour=0;
        else pump7.onHour=pump7.onHour+1;
        onHour=pump7.onHour;
        EEPROM.write(354,onHour); // save to memory
      }
      else if (scheduleItem==8) // for Pump8
      {
        if (pump8.onHour==23) pump8.onHour=0;
        else pump8.onHour=pump8.onHour+1;
        onHour=pump8.onHour;
        EEPROM.write(363,onHour); // save to memory
      }      
      //yusuf
    ...
    else if ((x>=85)&&(x<=109)&&(y>=140)&&(y<=164)) // on hour down
    {
      ...
      {
        if (pump4.onHour==0) pump4.onHour=23;
        else pump4.onHour=pump4.onHour-1;
        onHour=pump4.onHour;
        EEPROM.write(327,onHour); // save to memory
      }
      ...
      {
        if (pump5.onHour==0) pump5.onHour=23;
        else pump5.onHour=pump5.onHour-1;
        onHour=pump5.onHour;
        EEPROM.write(336,onHour); // save to memory
      }
      ...
      {
        if (pump6.onHour==0) pump6.onHour=23;
        else pump6.onHour=pump6.onHour-1;
        onHour=pump6.onHour;
        EEPROM.write(345,onHour); // save to memory
      }
      ...
      {
        if (pump7.onHour==0) pump7.onHour=23;
        else pump7.onHour=pump7.onHour-1;
        onHour=pump7.onHour;
        EEPROM.write(354,onHour); // save to memory
      }
      ...
      {
        if (pump8.onHour==0) pump8.onHour=23;
        else pump8.onHour=pump8.onHour-1;
        onHour=pump8.onHour;
        EEPROM.write(363,onHour); // save to memory
      }      
    ...
    else if ((x>=164)&&(x<=188)&&(y>=110)&&(y<=134)) // on min up
    {
      ...
      {
        if (pump4.onMinute==59) pump4.onMinute=0;
        else pump4.onMinute=pump4.onMinute+1;
        onMinute=pump4.onMinute;
        EEPROM.write(328,onMinute); // save to memory
      }
      else if (scheduleItem==5) // for Pump5
      {
        if (pump5.onMinute==59) pump5.onMinute=0;
        else pump5.onMinute=pump5.onMinute+1;
        onMinute=pump5.onMinute;
        EEPROM.write(337,onMinute); // save to memory
      }
      else if (scheduleItem==6) // for Pump6
      {
        if (pump6.onMinute==59) pump6.onMinute=0;
        else pump6.onMinute=pump6.onMinute+1;
        onMinute=pump6.onMinute;
        EEPROM.write(346,onMinute); // save to memory
      }
      else if (scheduleItem==7) // for Pump7
      {
        if (pump7.onMinute==59) pump7.onMinute=0;
        else pump7.onMinute=pump7.onMinute+1;
        onMinute=pump7.onMinute;
        EEPROM.write(355,onMinute); // save to memory
      }
      else if (scheduleItem==8) // for Pump8
      {
        if (pump8.onMinute==59) pump8.onMinute=0;
        else pump8.onMinute=pump8.onMinute+1;
        onMinute=pump8.onMinute;
        EEPROM.write(364,onMinute); // save to memory
      }   
      //yusuf
    ...
    else if ((x>=164)&&(x<=188)&&(y>=140)&&(y<=164)) // on min down
    {
      ...
      {
        if (pump4.onMinute==0) pump4.onMinute=59;
        else pump4.onMinute=pump4.onMinute-1;
        onMinute=pump4.onMinute;
        EEPROM.write(328,onMinute); // save to memory
      }
      ...
      {
        if (pump5.onMinute==0) pump5.onMinute=59;
        else pump5.onMinute=pump5.onMinute-1;
        onMinute=pump5.onMinute;
        EEPROM.write(337,onMinute); // save to memory
      }
      ...
      {
        if (pump6.onMinute==0) pump6.onMinute=59;
        else pump6.onMinute=pump6.onMinute-1;
        onMinute=pump6.onMinute;
        EEPROM.write(346,onMinute); // save to memory
      }
      ...
      {
        if (pump7.onMinute==0) pump7.onMinute=59;
        else pump7.onMinute=pump7.onMinute-1;
        onMinute=pump7.onMinute;
        EEPROM.write(355,onMinute); // save to memory
      }
      ...
      {
        if (pump8.onMinute==0) pump8.onMinute=59;
        else pump8.onMinute=pump8.onMinute-1;
        onMinute=pump8.onMinute;
        EEPROM.write(364,onMinute); // save to memory
      }   
